...
ICALL(MONIT_1, "Enter", mono_monitor_enter)
ICALL(MONIT_2, "Exit", mono_monitor_exit)
ICALL(MONIT_3, "Monitor_pulse", ves_icall_System_Threading_Monitor_Monitor_pulse)
ICALL(MONIT_4, "Monitor_pulse_all", ves_icall_System_Threading_Monitor_Monitor_pulse_all)
ICALL(MONIT_5, "Monitor_try_enter", ves_icall_System_Threading_Monitor_Monitor_try_enter)
ICALL(MONIT_6, "Monitor_wait", ves_icall_System_Threading_Monitor_Monitor_wait)
ICALL(MONIT_7, "try_enter_with_atomic_var", ves_icall_System_Threading_Monitor_Monitor_try_enter_with_atomic_var)
...
ICALL_TYPE(ST, "System.Threading.StInternalMethods", ST_1)
ICALL(ST_1, "Alloc_internal(intptr&)", ves_icall_System_Threading_StInternalMethods_Alloc_internal)
ICALL(ST_2, "Free_internal(intptr)", ves_icall_System_Threading_StInternalMethods_Free_internal)
ICALL(ST_3, "RegisterHandle_internal(StWaitable)", ves_icall_System_Threading_StInternalMethods_RegisterHandle_internal)
